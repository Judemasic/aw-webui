export default {
  ...
  settings: {
    ...
    groups: {
      ...
      categorizationHelp:
        'Regeln zur Einstufung von Ereignissen in Kategorien sowie AFK-/Aktivitäts-Overrides.',
      privacy: 'Datenschutz',
      privacyHelp:
        'Filter, die sensible Ereignisdaten vor dem Speichern verwerfen oder ausblenden.',
    ...
    categorization: {
      ...
      conflicts: {
        title: 'Widersprüchliche Aktivitäten',
        subtitle: 'Wenn zwei Regeln zutreffen, entscheiden Sie einmal',
        open: 'Konflikte anzeigen',
        hide: 'Konflikte ausblenden',
        help: 'Treffen mehrere Kategorien zu, gewinnt die tiefste. Zwei gleich tiefe Kategorien, die beide zutreffen, werden sonst danach entschieden, welche zuerst gespeichert wurde - also willkürlich. Antworten Sie einmal pro Aktivität; die Antwort gilt nur für diese Aktivität - eine andere Aktivität, auf die dieselben zwei Regeln zutreffen, wird erneut abgefragt.',
        unansweredTitle: 'Noch nicht beantwortet',
        scanning: 'Die Aktivität der letzten Woche wird durchsucht...',
        scanFailed: 'Die jüngste Aktivität konnte nicht gelesen werden.',
        none: 'Keine widersprüchlichen Aktivitäten in der letzten Woche.',
        matchedBy: 'Übereinstimmung mit:',
        pinnedTitle: 'Festgelegte Aktivitäten',
        pinnedHelp: 'Ihre bisherigen Antworten. Sie werden mit Ihren anderen Geräten geteilt.',
        noPins: 'Noch nichts festgelegt.',
        inert:
          'Diese Regeln widersprechen sich nicht mehr, daher wird diese Antwort nicht angewendet.',
        remove: 'Entfernen',
      },
    },
    developer: {
  ...
  activity: {
    ...
    resolveNow: 'Auflösen',
    resolveInline: {
      hide: 'Fragen ausblenden',
      openTimeline: 'In der Zeitleiste öffnen',
      answer: 'Beantworten',
    ...
    categorizeInline: {
      ...
      newCategoryHelp:
        'Erstellt eine Kategorie, deren Regel auf "{app}" passt. Den gesamten Satz bearbeiten Sie unter Einstellungen, Kategorisierung.',
      showMore: 'Mehr anzeigen',
  ...
  stopwatch: {
    ...
    aboutBody:
      'Manuell erfasste Sitzungen neben der automatischen Erfassung verfolgen. Um Stoppuhr-Summen im Dashboard zu sehen, öffnen Sie eine Aktivitätsansicht, klicken Sie auf Ansicht bearbeiten, dann Visualisierung hinzufügen und wählen Sie Top-Stoppuhr-Ereignisse.',
