export default {
  ...
  settings: {
    ...
    categorization: {
      ...
      conflicts: {
        title: 'Conflicting activities',
        subtitle: 'When two rules both match, you decide once',
        open: 'Open conflicts',
        hide: 'Hide conflicts',
        help: 'If several categories match, the deepest one wins. Two categories at the same depth that both match are otherwise decided by whichever was stored first, which is arbitrary. Answer once per activity and the answer is remembered for that activity only — a different activity that matches the same two rules is asked about again.',
        unansweredTitle: 'Not yet answered',
        scanning: 'Looking through the last week of activity...',
        scanFailed: 'Could not read recent activity.',
        none: 'No conflicting activities in the last week.',
        matchedBy: 'Matched by:',
        pinnedTitle: 'Pinned activities',
        pinnedHelp: 'Answers you have given. They are shared with your other devices.',
        noPins: 'Nothing pinned yet.',
        inert: 'These rules no longer conflict, so this answer is not being applied.',
        remove: 'Remove',
      },
    },
    developer: {
  ...
  activity: {
    ...
    resolveInline: {
      ...
      answer: 'Answer',
      showMore: 'Show more',
      allAnswered: 'Everything here has been answered.',
    ...
    categorizeInline: {
      ...
      newCategoryHelp:
        'Creates a category whose rule matches "{app}". Edit the whole set under Settings, Categorization.',
      showMore: 'Show more',
